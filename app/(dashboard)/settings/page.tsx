...
import { sendFriendRequest, getFriends, getPendingRequests, respondToFriendRequest, type FriendProfile } from "@/src/actions/social";
...
export default function SettingsPage() {
  ...
  const [pendingReqs, setPendingReqs] = useState<Array<{ id: string; fromName: string; fromId: string }>>([]);
